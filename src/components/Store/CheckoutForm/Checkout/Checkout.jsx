...
const Checkout = ({ cart, order, onCaptureCheckout, error, user }) => {
    ...
    function RedirectGuest(){
        return(
            ...
            <div className='redirect-container'>
                ...
                <Link className='redirect-a' to="/register">Please sign up to continue checking out</Link>
    ...
    return (
        <>
        {user && user.success === undefined && 
        <Loading/>
        }
        {user && user.isLoggedIn === false && user.success === false && 
        <>
        <RedirectGuest/>
        <CheckoutDisplay/>
        </>
